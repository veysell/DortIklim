...
<div class="owl-carousel-wrapper">
    ...
    <div class="owl-carousel owl-1 ">
        ...
        foreach ($sliders as $slider) {
            ?>
            <div class="ftco-cover-1 overlay" style="background-image: url('images/<?=$slider["ImagePath"]?>');">
                <div class="box-92819">
                    <h1 class="text-white mb-3"><?=$slider["Description"]?></h1>
                </div>
            </div>
            <?php
        }
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="event-29191 mb-5">
                    <a href="#" class="d-block mb-3"><img src="images/img_1.jpg" alt="Image"
                    ...
                    <div class="px-3 d-flex">
                        ...
                        <div>
                            <div class="mb-3">
                                <span class="mr-3"> <span class="icon-clock-o mr-2 text-muted"></span>9:30 AM
                                    &mdash; 11:30 AM</span>

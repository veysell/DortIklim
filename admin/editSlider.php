                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="post" action="addSlider" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="sliderName" id="exampleInputName1" placeholder="Yeni Slider İsmi Giriniz...">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="sliderImage">Yeni Slider Resmi <i style="font-size: 90%; color: #6c7293;">(Slider
                                        resmi en az 1280x800 boyutunda olmalıdır!)</i></label>
                                <input type="file" id="sliderImage" name="Url" class="file-upload-default" onchange="previewImage(event)">
                                <div class="input-group col-xs-12">
                                    <input type="text" class="form-control file-upload-info" disabled placeholder="Resmi Güncelle">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="exampleTextarea1" name="sliderDesc" rows="4" placeholder="Slider alanında görünecek metni yeni giriniz..."></textarea>
                            </div>
                ...
                <div class="col-md-8 col-xl-6 grid-margin stretch-card mb-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Resim eklendi -->
                            <img src="../images/hero_1.jpg" alt="Eski Görünüm" class="img-fluid rounded-circleS">
                        </div>

                        <div class="card-body">
                            <h4 class="card-title">Güncel Görünüm</h4>
                            <!-- Resim eklendi -->
                            <img src="../images/hero_1.jpg" alt="Güncel Görünüm" class="img-fluid rounded-circleS" >
                            <div></div>
                        </div>
                    </div>
                </div>
